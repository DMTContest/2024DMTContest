...
{   
    ...
    void Start()
    {
        ...
        FinalScore.text = 
        (TimeManager.Jcorrect*30 - (TimeManager.JWR1+TimeManager.JWR2+TimeManager.JWR3)*5+ TimeManager.Mcorrect*50 - (TimeManager.MWR1+TimeManager.MWR2+TimeManager.MWR3)*10+ TimeManager.Hcorrect*80 - (TimeManager.HWR1+TimeManager.HWR2+TimeManager.HWR3+TimeManager.HWR4)*20).ToString();
    }   
